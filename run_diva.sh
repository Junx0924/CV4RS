...
python /home/users/j/jun0924/CV4RS/train_diva.py  --log_online --dataset MLRSNet  --project MLRSNet  --source_path "/scratch/CV4RS/Dataset" --save_path "/home/users/j/jun0924/Training_Results" --group diva --num_samples_per_class 2 --frozen --savename discriminative  --diva_features discriminative --eval_epoch 20
python /home/users/j/jun0924/CV4RS/train_diva.py  --log_online --dataset MLRSNet  --project MLRSNet  --source_path "/scratch/CV4RS/Dataset" --save_path "/home/users/j/jun0924/Training_Results" --group diva --num_samples_per_class 2 --frozen --savename combin --eval_epoch 20
