...
python /home/users/j/jun0924/CV4RS/train_diva.py  --log_online --dataset BigEarthNet  --project BigEarthNet  --source_path "/scratch/CV4RS/Dataset" --save_path "/home/users/j/jun0924/Training_Results" --group diva --num_samples_per_class 6 --use_hdf5 --frozen  --savename combin
