"""========== MLRSNet ==========="""
### ResNet50
python diva_main.py --dataset MLRSNet --log_online --project DiVA_MLRSNet --diva_ssl fast_moco --source_path "/home/users/j/jun0924/Dataset" --save_path "/home/users/j/jun0924/Diva" --group CUB_DiVA-R50-512 --tau 55 --gamma 0.2 --diva_alpha_ssl 0.3 --diva_alpha_shared 0.3 --diva_alpha_intra 0.3 --diva_rho_decorrelation 1500 1500 1500 --diva_features discriminative selfsimilarity shared intra --diva_sharing random --evaltypes all --diva_moco_temperature 0.01  --diva_moco_n_key_batches 30 --n_epochs 350 --seed 0 --gpu 0 --samples_per_class 2 --loss margin --batch_mining distance --arch resnet50_frozen_normalize --embed_dim 128
### Inception-BN
python diva_main.py --dataset MLRSNet --log_online --project DiVA_MLRSNet --diva_ssl fast_moco --source_path  "/home/users/j/jun0924/Dataset" --save_path "/home/users/j/jun0924/Diva" --group CUB_DiVA-IBN-512 --gamma 0.3 --tau 70 --diva_alpha_ssl 0.1 --diva_alpha_shared 0.1 --diva_alpha_intra 0.1 --diva_rho_decorrelation 300 300 300 --diva_features discriminative selfsimilarity shared intra --diva_sharing random --evaltypes all --diva_moco_temperature 0.01  --diva_moco_n_key_batches 30 --n_epochs 350 --seed 0 --gpu 0 --samples_per_class 2 --loss margin --batch_mining distance --arch bninception_normalize --embed_dim 128
