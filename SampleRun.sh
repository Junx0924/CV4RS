...
### for training
python ./train_bier.py  --log_online --dataset MLRSNet  --project MLRSNet  --source_path ".../Dataset" --save_path "../Training_Results" --savename 'bier' --group bier  --num_samples_per_class 2 --frozen  --use_npmem --eval_epoch 10 --nb_epochs 120  
...
python ./evaluate_model.py --load_from_checkpoint "../Training_Results/BigEarthNet/dac" --source_path ".../Dataset" 
python ./evaluate_model.py --load_from_checkpoint "../Training_Results/MLRSNet/baseline" --source_path ".../Dataset" 
python ./evaluate_model.py --load_from_checkpoint "../Training_Results/BigEarthNet/baseline" --source_path ".../Dataset" 
python ./evaluate_model.py --load_from_checkpoint "../Training_Results/MLRSNet/bier" --source_path ".../Dataset" 
python ./evaluate_model.py --load_from_checkpoint "../Training_Results/BigEarthNet/bier" --source_path ".../Dataset" 
python ./evaluate_model.py --load_from_checkpoint "../Training_Results/MLRSNet/diva" --source_path ".../Dataset" 
python ./evaluate_model.py --load_from_checkpoint "../Training_Results/BigEarthNet/diva" --source_path ".../Dataset" 