...
### for training
python ./train_bier.py  --log_online --dataset MLRSNet  --project MLRSNet  --source_path "/scratch/CV4RS/Dataset" --save_path "../Training_Results" --savename 'bier' --group bier  --num_samples_per_class 2 --frozen  --use_npmem --eval_epoch 10 --nb_epochs 120 --bier_beta_trainable
...
python ./train_diva.py  --log_online --dataset MLRSNet  --project MLRSNet  --source_path "/scratch/CV4RS/Dataset" --save_path "../Training_Results"  --savename 'baseline' --group baseline --num_samples_per_class 2 --use_npmem --frozen   -eval_epoch 10 --nb_epochs 120 --diva_features 'discriminative'

python ./train_bier.py  --log_online --dataset BigEarthNet  --project BigEarthNet  --source_path "/scratch/CV4RS/Dataset" --save_path "../Training_Results"  --savename 'bier' --group bier  --num_samples_per_class 2 --frozen  --use_npmem --eval_epoch 10 --nb_epochs 120 --bier_beta_trainable
...
python ./train_diva.py  --log_online --dataset BigEarthNet  --project BigEarthNet  --source_path "/scratch/CV4RS/Dataset" --save_path "../Training_Results"  --savename 'baseline' --group baseline --num_samples_per_class 2 --use_npmem --frozen    -eval_epoch 10 --nb_epochs 120 --diva_features 'discriminative'
